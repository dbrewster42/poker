...
@Service
public class OldGamesContainer {
...
//
//
//    public OldGamesContainer(UserService userService) {
//        this.userService = userService;
//    }
//
//    public GameService findGameById(long id){
...
//        GameService game = new OldTexasHoldEmService(gameID, player, settingsRequest, userService);
//        gameID++;
//        allGames.add(game);
//        return game;
//    }
...
//        HumanPlayer player = convertUserToPlayer(userDto, settingsRequest.getDisplayName());
//        GameService game = new OldTexasHoldEmService(gameID, players, settingsRequest, userService);
//        gameID++;
//        allGames.add(game);
//        players.add(player);
//        return game;
